...
class TopicController {
    public async getTopics(req: Request, res: Response) {
        try {
            ...
            return responseGenerator.getSuccessResponse(res, 'topics Fetched Successfully', topics);
        } catch (error) {
    ...
    public async getTopicById(req: Request, res: Response) {
        ...
        try {
            ...
            return responseGenerator.getSuccessResponse(res, 'Topic Fetched Successfully', topic);
        } catch (error) {
    ...
    public async createTopic(req: Request, res: Response) {
        ...
        try {
            ...
            return responseGenerator.getSuccessResponse(res, 'Topic Successfully Created', topic);
        } catch (error: any) {
            logger.error('An error occurred:', error);
            return responseGenerator.getErrorResponse(res, 500);
        }
    ...
    public async deleteTopic(req: Request, res: Response) {
        ...
        try {
            ...
            return responseGenerator.getSuccessResponse(res, 'topic Successfully Deleted');
        } catch (error) {
            logger.error('An error occurred:', error);
            return responseGenerator.getErrorResponse(res, 404);
        }
    ...
    public async updatetTopic(req: Request, res: Response) {
        ...
        try {
            ...
            return responseGenerator.getSuccessResponse(res, 'topic Updated Successfully');
        } catch (error) {
            logger.error('An error occurred:', error);
            return responseGenerator.getErrorResponse(res, 404);
        }

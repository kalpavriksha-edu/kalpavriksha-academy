...
class AssignmentController {
    public async getAssignments(req: Request, res: Response) {
        try {
            ...
            return responseGenerator.getSuccessResponse(res, successEnums.FETCHED, assignments);
        } catch (error) {
            logger.error(error);
    ...
    public async getAssignmentById(req: Request, res: Response) {
        ...
        try {
            ...
            return responseGenerator.getSuccessResponse(res, successEnums.FETCHED, assignment);
        } catch (error) {
            logger.error(error);
    ...
    public async createAssignment(req: Request, res: Response) {
        ...
        try {
            ...
            return responseGenerator.getSuccessResponse(res, successEnums.CREATED, assignment);
        } catch (error: any) {
            logger.error(error);
            return responseGenerator.getErrorResponse(res, 500);
        }
